...
class Mage_Catalog_Helper_Image extends Mage_Core_Helper_Abstract
{
    ...
    {
        try {
            //------------------ #1. customized by Lanot ----------------------------
            Mage::dispatchEvent('catalog_product_prepare_image_output_before', array(
                'helper'  => $this,
            ...
            if ($model->isCached()) {
                ...
                //------------------ #2. customized by Lanot ----------------------------
                Mage::dispatchEvent('catalog_product_prepare_image_output_after', array(
                    'helper'  => $this,
                    'model'   => $this->_getModel(),
                    'product' => $this->_product,
                ));
